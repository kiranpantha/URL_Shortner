...
if ( isset($_POST['longurl']) && isset($_POST['longurl2']) )
{
...
<html>
	...
	<body onload="document.getElementById('longurl').focus()">
		...
		<h1>Go.Kiran.CF [Chort Form]</h1>
		
		<?php echo '<br /><br /><font color="red">Sorry, That url is not a Valid Shorted Url  Sorry</font>'; ?>
		<?php if($msg=='<p class="error">Sorry, but that lil&#180; URL isn\'t in our database.</p>')
		{
				echo '<script type="text/javascript" language="javascript">
<!--
if(confirm("Sorry, That url is not a Valid Shorted Url \n Sorry")){
}
else
{
	document.location="http://kiranpantha.com.np";
}
-->
</script>'
;
